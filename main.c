...
int main(int argc, char *argv[]) {
    ...
    // create boarder
    insertAndSetFirstWall(&head, 1, 0, 0, 1000, 30);
    insertAndSetFirstWall(&head, 2, 0, 0, 30, 1000);
    insertAndSetFirstWall(&head, 3, 970, 0, 30, 1000); 
    insertAndSetFirstWall(&head, 4, 0, 970, 1000, 30); 
    // maze walls 
    insertAndSetFirstWall(&head, 5, 0, 830, 800, 50);
    insertAndSetFirstWall(&head, 6, 180, 720, 820, 50); 
    insertAndSetFirstWall(&head, 7, 900, 900, 100, 820);
    insertAndSetFirstWall(&head, 8, 900, 0, 100, 820);
    insertAndSetFirstWall(&head, 9, 0, 500, 700, 100);
    insertAndSetFirstWall(&head, 10, 0, 0, 450, 500);
    insertAndSetFirstWall(&head, 11, 500, 0, 500, 450);
    // insertAndSetFirstWall(&head, 1, 0, 0, 1000, 100);
    // insertAndSetFirstWall(&head, 2, 200, 225, 100, 10);
    setup_robot(&robot);
    updateAllWalls(head, renderer);

    SDL_Event event;
    while(!done){
        SDL_SetRenderDrawColor(renderer, 0, 252, 253, 255);
        ...
        if (checkRobotReachedEnd(&robot, 0, 0, 1000, 150)){
            end_time = clock();
